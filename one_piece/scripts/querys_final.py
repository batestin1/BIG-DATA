...
one = spark.read.orc("C:/Users/Bates/Documents/Repositorios/BIGDATA/one_piece/stagin/gold/orc/one/").createOrReplaceTempView("one")
...
###################load########################################
censu_notuser_fruit_payload.write.mode("overwrite").format("orc").save("C:/Users/Bates/Documents/Repositorios/BIGDATA/one_piece/output/onepiece/censu_notuser_fruit_payload")
censu_user_fruit_payload.write.mode("overwrite").format("orc").save("C:/Users/Bates/Documents/Repositorios/BIGDATA/one_piece/output/onepiece/censu_user_fruit_payload")
