...
sandman = spark.read.parquet("C:/Users/Bates/Documents/Repositorios/BIGDATA/sandman/stagin/gold/sandman").createOrReplaceTempView("sandman")
...
sand.write.mode("overwrite").format("parquet").partitionBy("dreaming_date").save("C:/Users/Bates/Documents/Repositorios/BIGDATA/sandman/output/raw/sandman")
resume.write.mode("overwrite").format("parquet").save("C:/Users/Bates/Documents/Repositorios/BIGDATA/sandman/output/resume/sandman")
