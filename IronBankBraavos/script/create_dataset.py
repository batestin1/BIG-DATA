...
for x in range(val):
    ...
    with open(f"C:/Users/Bates/Documents/Repositorios/BIGDATA/IronBankBraavos/source/client/cl_{num}.json", "w", encoding='utf-8') as out1:
          with open(f"C:/Users/Bates/Documents/Repositorios/BIGDATA/IronBankBraavos/source/address/ad_{num}.json", "w", encoding='utf-8') as out2:
            with open(f"C:/Users/Bates/Documents/Repositorios/BIGDATA/IronBankBraavos/source/account/ac_{num}.json", "w", encoding='utf-8') as out3:
              with open(f"C:/Users/Bates/Documents/Repositorios/BIGDATA/IronBankBraavos/source/accountcard/accard_{num}.json", "w", encoding='utf-8') as out4:
                with open(f"C:/Users/Bates/Documents/Repositorios/BIGDATA/IronBankBraavos/source/card/card_{num}.json", "w", encoding='utf-8') as out5:
                   with open(f"C:/Users/Bates/Documents/Repositorios/BIGDATA/IronBankBraavos/source/rent/rent_{num}.json", "w", encoding='utf-8') as out8:
                          ##################### variables ##############################
